<footer class="footer sm:footer-horizontal bg-neutral text-neutral-content p-9 ">
  ...
  <nav>
    ...
    <div class="grid grid-flow-col gap-4">
        <a href="https://www.instagram.com/alfrdo.jsx" aria-label="instagram" target="_blank">
            <svg class="w-6 h-6 text-gray-800 dark:text-white hover:text-red-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                <path fill="currentColor" fill-rule="evenodd" d="M3 8a5 5 0 0 1 5-5h8a5 5 0 0 1 5 5v8a5 5 0 0 1-5 5H8a5 5 0 0 1-5-5V8Zm5-3a3 3 0 0 0-3 3v8a3 3 0 0 0 3 3h8a3 3 0 0 0 3-3V8a3 3 0 0 0-3-3H8Zm7.597 2.214a1 1 0 0 1 1-1h.01a1 1 0 1 1 0 2h-.01a1 1 0 0 1-1-1ZM12 9a3 3 0 1 0 0 6 3 3 0 0 0 0-6Zm-5 3a5 5 0 1 1 10 0 5 5 0 0 1-10 0Z" clip-rule="evenodd"/>
            </svg>
        </a>

        <a href="https://github.com/AlfreGood20" aria-label="github" target="_blank">
            <svg class="w-6 h-6 text-gray-800 dark:text-white hover:text-neutral-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
        ...
        <a  href="https://www.facebook.com/josealfredo.lopezdelacruz.58" aria-label="facebook" target="_blank">
        ...
        <a href="https://www.reddit.com/user/Alfre416_44/?utm_source=share&utm_medium=web3x&utm_name=web3xcss&utm_term=1&utm_content=share_button" aria-label="redit" target="_blank">
            <svg class="w-6 h-6 text-gray-800 dark:text-white hover:text-orange-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
        ...
        <a  href="https://www.youtube.com/@alfredopro20" aria-label="youtube" target="_blank">
            <svg class="w-6 h-6 text-gray-800 dark:text-white hover:text-red-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
